...
import Mailer from './alx-files_manager/utils/mailer';
...
userQueue.process(async (job, done) => {
  ...
  try {
    ...
    const mailContent = [
      ...
      'Welcome to <a href="https://github.com/bizzy604/alx-files_manager">',
      'ALX-Files_Manager</a>, ',
      'a simple file management API built with Node.js by ',
      '<a href="https://github.com/bizzy604">Amoni Kevin</a>. ',
      'Happy codng!',
      '</div>',
    ].join('');
